...
map({
  ...
  { "qH", "f<", { modes = { "n", "v", "o" }, desc = "t<" } },
  { "qN", "f(", { modes = { "n", "v", "o" }, desc = "t(" } },
  { "qE", "f[", { modes = { "n", "v", "o" }, desc = "t[" } },
  { "qI", "f{", { modes = { "n", "v", "o" }, desc = "t{" } },
  { "qO", "f'", { modes = { "n", "v", "o" }, desc = "t'" } },
  { "qL", 'f"', { modes = { "n", "v", "o" }, desc = 't"' } },
  { "qU", "f`", { modes = { "n", "v", "o" }, desc = "t`" } },
