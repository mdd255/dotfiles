    ...
    config = function()
      require("onedarkpro").setup({
        ...
        highlights = {
          ...
          SpellBad = { underline = true, bg = hi.yellow, blend = 30 },
          SpellCap = { underline = true, bg = hi.yellow, blend = 30 },
          SpellRare = { underline = true, bg = hi.yellow, blend = 30 },
          SpellLocal = { underline = true, bg = hi.yellow, blend = 30 },
